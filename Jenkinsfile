...
//    }
    ...
    stage('db migrate use kubectl run') {
      ...
      steps {
        ...
        sh "kubectl run optimus-migrate --image=${IMAGE_REPO}/${IMAGE_NAME}:staging-90 --restart='Never' --env='namespace=${NAMESPACE}' -- echo $namespace; sleep 30; echo 'test migrate'; echo $?"
      }
